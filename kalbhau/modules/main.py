...
from kalbhau.core.get_func import get_msg
from kalbhau.core.func import *
from kalbhau.core.mongo import db
from pyrogram.errors import FloodWait
from datetime import datetime, timedelta
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
import subprocess
from kalbhau.modules.shrink import is_user_verified
...
async def single_link(_, message):
    ...
    if await subscribe(app, message) or user_id in batch_mode:
        return
...
async def batch_link(_, message):
    if await subscribe(app, message):
        return
    user_id = message.chat.id
