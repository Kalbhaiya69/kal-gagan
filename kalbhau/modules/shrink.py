...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://graph.org/file/3eddaf2b77f5e2352640b-1cf1914d750ca43925.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/+0rEj-Cp7bBQ0YmU1")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/kalbhau01")
    ...
    if freecheck != 1:
        await message.reply("You are a premium user. Contact @kalbhau01")
        return
...
@app.on_message(filters.command("tokesdcn"))
