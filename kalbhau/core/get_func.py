...
if STRING:
    from kalbhau import pro
    print("App imported from kalbhau.")
else:
    pro = None
        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__ㅤ@kalbhau01__**."
                )
                return
...
async def clone_message(app, msg, target_chat_id, topic_id, edit_id, log_group):
    ...
    kalbhau_bot = await app.send_message(target_chat_id, msg.text.markdown, reply_to_message_id=topic_id)
    await kalbhau_bot.copy(log_group)
    await edit.delete()
...
get_user_rename_preference = lambda user_id: user_rename_preferences.get(str(user_id), '@kalbhau01')
...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/kalbhau01")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **kalbhau01 ⚡**, built on Telethon(base), by @kalbhau01 still in beta.__", buttons=buttons)
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/kalbhau01")]
                ]
            )
