...
from config import API_ID, API_HASH, BOT_TOKEN, STRING, DEFAULT_SESSION
...
loop.run_until_complete(restrict_bot())f getme.last_name else getme.first_name
...
loop.run_until_complete(restrict_bot()) when the bot starts
